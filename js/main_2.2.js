var projects = [{
    ...
    id: 13,
    title: "Geotab HR Automation",
    description: "For the summer of 2017, I was a Jr. Software Developer Intern for the HR Department at Geotab. The goal of this project was to increase the efficiency of Geotab's HR Department by automating many tedious, time-consuming tasks. I created a collection of Docs, Forms, and Spreadsheets using Google Apps Script to automate many of the tasks, summarized below. As much of this is internal data, I cannot go into detail or include screenshots of the project itself for security purposes.<br><br>&bull;&nbsp;&nbsp;Job Applications<br>&bull;&nbsp;&nbsp;Interviews<br>&bull;&nbsp;&nbsp;Handling Employee Files<br>&bull;&nbsp;&nbsp;Scheduling Meetings<br>&bull;&nbsp;&nbsp;Emails<br>&bull;&nbsp;&nbsp;Internal Reporting<br>&bull;&nbsp;&nbsp;Resume Parsing<br>&bull;&nbsp;&nbsp;Workshop Registration<br>&bull;&nbsp;&nbsp;Performance Reviews<br>&bull;&nbsp;&nbsp;File Revision History",
    images: ["geotab.png"],
    type: "work",
    ...
    id: 15,
    title: "ZippyFix",
    description: "Freelance graphic design work for a handyman service company, ZippyFix. Created numerous design mockups including a logo, website, and mobile application redesign.",
    images: ["zippy.png", "zippy2.png", "zippy3.png", "zippy4.png", "zippy5.png"],
    type: "work",
    thumbnail: "zippy.png",
    languages: ["Adobe Illustrator, Canva, Swift 3"]
}];
